...
import { buildCheckinAlertsFromCotacao, TELEGRAM_ALERT_REFERENCIA_ATUAL_REGEX } from "@/lib/telegram-alertas";
    ...
    handlers: {
      POST: async ({ request }) => {
        ...
        const { data: pending, error: pendingError } = await supabaseAdmin
          ...
          .eq("status", "Pendente")
          .filter("referencia", "match", TELEGRAM_ALERT_REFERENCIA_ATUAL_REGEX.source)
